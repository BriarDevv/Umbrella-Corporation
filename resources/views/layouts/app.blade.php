<!DOCTYPE html>
<html lang="en" class="bg-[#050505] text-[#9CACAD]">
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="theme-color" content="#050505" />
    <meta name="robots" content="noindex,nofollow" />
    <title>@yield('title', 'Internal Catalog') :: Umbrella Research Division</title>
    <meta name="description" content="@yield('description', 'Classified ecommerce interface for fictional research files, containment equipment and biological simulation assets.')" />
