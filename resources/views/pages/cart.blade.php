...
@section('description', 'Inventario clasificado a la espera de autorización interna. Módulo de checkout pendiente de aprobación.')
    ...
    <div class="container-tech">
        ...
        <div class="grid gap-10 lg:grid-cols-12 mt-8 items-end">
            <div class="lg:col-span-8 flex flex-col gap-5">
                ...
                <h1 id="cart-heading" data-animate="fade-up">Carrito de Autorización</h1>
                <p class="text-[#9CACAD] max-w-2xl" data-animate="fade-up">
                    Ítems reservados para revisión interna. El checkout requiere autorización manual. La interfaz se presenta sólo con fines visuales — no hay capa transaccional activa.
                </p>
            </div>
            ...
            <div class="lg:col-span-4" data-animate="panel">
                <div class="clearance-panel">
                    ...
                    <p class="font-classified text-[0.7rem] tracking-[0.24em] text-[#ED1C24] mt-2">REVISIÓN PENDIENTE</p>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-8 flex flex-col gap-4" data-animate-table>
            ...
            <div class="border border-[#5D6E6E]/30 bg-[#0A0A0A] p-5 flex items-center justify-between gap-4">
                <span class="inline-flex items-center gap-3 font-classified text-[0.7rem] tracking-[0.28em] text-[#ED1C24]">
                    ...
                    Todos los ítems pendientes de revisión manual.
                </span>
                <span class="font-classified text-[0.7rem] tracking-[0.24em] text-[#9CACAD]">ID&nbsp;CARRITO&nbsp;·&nbsp;PA-2024-44</span>
            </div>
        </div>
        ...
        <aside class="lg:col-span-4 flex flex-col gap-5" data-animate="panel">
            <div class="technical-panel">
                ...
                <dl class="mt-4 flex flex-col gap-3 text-sm">
                    ...
                    <div class="flex items-center justify-between">
                        <dt class="text-[#9CACAD]">Tarifa de Autorización</dt>
                        <dd class="text-[#9CACAD]">Pendiente</dd>
                    </div>
            ...
            <div class="clearance-panel">
                ...
                <p class="text-sm text-[#9CACAD]">
                    Módulo de checkout pendiente de aprobación interna. Todos los ítems permanecen en estado pendiente hasta que el comité de supervisión registre la autorización.
                </p>
            </div>
